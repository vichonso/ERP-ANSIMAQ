...
CREATE TABLE contrato (
    ...
    horascontrtado INTEGER, -- Horas contratadas del equipo
...
CREATE TABLE cobros (
    ...
    id_historial INTEGER REFERENCES historial_contrato(id_historial) ON DELETE CASCADE, -- Referencia al historial de contrato
    numero_vigente INTEGER REFERENCES equipos(numero_vigente) ON DELETE CASCADE, -- Referencia al equipo arrendado
